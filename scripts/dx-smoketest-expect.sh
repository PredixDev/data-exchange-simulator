...
expect dx-simulator.expect https://raw.githubusercontent.com/PredixDev/data-exchange-simulator/master/scripts --skip-setup ${env.instancePrefix} ${env.UAA_ISSUREID} ${env.TS_ZONE}
